...
regex_body
  = char_:regex_first_char chars:regex_chars {
      return char_ + chars;
    }
...
regex_class
  = "[" chars:regex_class_chars "]" { return "[" + chars + "]"; }

regex_class_chars
  = chars:regex_class_char* { return chars.join(""); }
...
regex_flags
  = parts:identifier_part* { return parts.join(""); }
...
identifier_start
  ...
  / "$"
  / "_"
  / "\\" sequence:unicode_escape_sequence { return sequence; }
